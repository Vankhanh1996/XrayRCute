...
install_XrayR() {
	...
	bash <(curl -Ls https://raw.githubusercontent.com/Vankhanh1996/XrayRCute/master/install.sh)
}
...
makeConfig() {
	...
	echo "---------------"
	read -p "Link website: https://5gvietnam.net"
	echo "---------------"
	read -p "API key của web: 5gvietnam5gvietnam"
	echo "---------------"
...
Nodes:
  -
    PanelType: "V2board" 
    ApiConfig:
      ApiHost: "https://5gvietnam.net"
      ApiKey: "5gvietnam5gvietnam"
      NodeID: $NodeID80
      NodeType: V2ray 
      Timeout: 30 
      EnableVless: false 
  ...
  -
    ...
    ControllerConfig:
      ...
      CertConfig:
        ...
        CertFile: /etc/XrayR/cert-cloudfly/5gvietnam.crt 
        KeyFile: /etc/XrayR/cert-cloudfly/5gvietnam.key
        Provider: cloudflare 
        Email: test@me.com
        DNSEnv: 
          CLOUDFLARE_EMAIL: 
